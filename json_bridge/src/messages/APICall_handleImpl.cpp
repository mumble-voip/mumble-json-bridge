...
const std::unordered_set<std::string> APICall::s_allFunctions = {
	"freeMemory",
...
const std::unordered_set<std::string> APICall::s_noParamFunctions = {
	"getActiveServerConnection",
	"getLocalUserTransmissionMode"
};

nlohmann::json handle_freeMemory(const MumbleAPI &api, const std::string &bridgeSecret, const nlohmann::json &parameter) {
	// Validate specified parameter
	if (parameter.size() != 1) {
		throw InvalidMessageException(std::string("API function \"freeMemory\" expects 1 parameter(s) but got ") + std::to_string(parameter.size()));
	}
...
nlohmann::json handle_isConnectionSynchronized(const MumbleAPI &api, const std::string &bridgeSecret, const nlohmann::json &parameter) {
	// Validate specified parameter
	if (parameter.size() != 1) {
		throw InvalidMessageException(std::string("API function \"isConnectionSynchronized\" expects 1 parameter(s) but got ") + std::to_string(parameter.size()));
	}
...
nlohmann::json handle_getLocalUserID(const MumbleAPI &api, const std::string &bridgeSecret, const nlohmann::json &parameter) {
	// Validate specified parameter
	if (parameter.size() != 1) {
		throw InvalidMessageException(std::string("API function \"getLocalUserID\" expects 1 parameter(s) but got ") + std::to_string(parameter.size()));
	}
	MESSAGE_ASSERT_FIELD(parameter, "connection", number_integer);
...
nlohmann::json handle_getUserName(const MumbleAPI &api, const std::string &bridgeSecret, const nlohmann::json &parameter) {
	// Validate specified parameter
	if (parameter.size() != 2) {
		throw InvalidMessageException(std::string("API function \"getUserName\" expects 2 parameter(s) but got ") + std::to_string(parameter.size()));
	}
	MESSAGE_ASSERT_FIELD(parameter, "connection", number_integer);
...
nlohmann::json handle_getChannelName(const MumbleAPI &api, const std::string &bridgeSecret, const nlohmann::json &parameter) {
	// Validate specified parameter
	if (parameter.size() != 2) {
		throw InvalidMessageException(std::string("API function \"getChannelName\" expects 2 parameter(s) but got ") + std::to_string(parameter.size()));
	}
	MESSAGE_ASSERT_FIELD(parameter, "connection", number_integer);
...
nlohmann::json handle_getAllUsers(const MumbleAPI &api, const std::string &bridgeSecret, const nlohmann::json &parameter) {
	// Validate specified parameter
	if (parameter.size() != 1) {
		throw InvalidMessageException(std::string("API function \"getAllUsers\" expects 1 parameter(s) but got ") + std::to_string(parameter.size()));
	}
	MESSAGE_ASSERT_FIELD(parameter, "connection", number_integer);
...
nlohmann::json handle_getAllChannels(const MumbleAPI &api, const std::string &bridgeSecret, const nlohmann::json &parameter) {
	// Validate specified parameter
	if (parameter.size() != 1) {
		throw InvalidMessageException(std::string("API function \"getAllChannels\" expects 1 parameter(s) but got ") + std::to_string(parameter.size()));
	}
	MESSAGE_ASSERT_FIELD(parameter, "connection", number_integer);
...
nlohmann::json handle_getChannelOfUser(const MumbleAPI &api, const std::string &bridgeSecret, const nlohmann::json &parameter) {
	// Validate specified parameter
	if (parameter.size() != 2) {
		throw InvalidMessageException(std::string("API function \"getChannelOfUser\" expects 2 parameter(s) but got ") + std::to_string(parameter.size()));
	}
	MESSAGE_ASSERT_FIELD(parameter, "connection", number_integer);
	MESSAGE_ASSERT_FIELD(parameter, "user_id", number_unsigned);
...
nlohmann::json handle_getUsersInChannel(const MumbleAPI &api, const std::string &bridgeSecret, const nlohmann::json &parameter) {
	// Validate specified parameter
	if (parameter.size() != 2) {
		throw InvalidMessageException(std::string("API function \"getUsersInChannel\" expects 2 parameter(s) but got ") + std::to_string(parameter.size()));
	}
	MESSAGE_ASSERT_FIELD(parameter, "connection", number_integer);
	MESSAGE_ASSERT_FIELD(parameter, "channel_id", number_integer);
...
nlohmann::json handle_isUserLocallyMuted(const MumbleAPI &api, const std::string &bridgeSecret, const nlohmann::json &parameter) {
	// Validate specified parameter
	if (parameter.size() != 2) {
		throw InvalidMessageException(std::string("API function \"isUserLocallyMuted\" expects 2 parameter(s) but got ") + std::to_string(parameter.size()));
	}
	MESSAGE_ASSERT_FIELD(parameter, "connection", number_integer);
	MESSAGE_ASSERT_FIELD(parameter, "user_id", number_unsigned);
...
nlohmann::json handle_isLocalUserMuted(const MumbleAPI &api, const std::string &bridgeSecret, const nlohmann::json &parameter) {
	// Validate specified parameter
	if (parameter.size() != 1) {
		throw InvalidMessageException(std::string("API function \"isLocalUserMuted\" expects 1 parameter(s) but got ") + std::to_string(parameter.size()));
	}
	MESSAGE_ASSERT_FIELD(parameter, "connection", number_integer);
...
nlohmann::json handle_isLocalUserDeafed(const MumbleAPI &api, const std::string &bridgeSecret, const nlohmann::json &parameter) {
	// Validate specified parameter
	if (parameter.size() != 1) {
		throw InvalidMessageException(std::string("API function \"isLocalUserDeafed\" expects 1 parameter(s) but got ") + std::to_string(parameter.size()));
	}
	MESSAGE_ASSERT_FIELD(parameter, "connection", number_integer);
...
nlohmann::json handle_getUserHash(const MumbleAPI &api, const std::string &bridgeSecret, const nlohmann::json &parameter) {
	// Validate specified parameter
	if (parameter.size() != 2) {
		throw InvalidMessageException(std::string("API function \"getUserHash\" expects 2 parameter(s) but got ") + std::to_string(parameter.size()));
	}
	MESSAGE_ASSERT_FIELD(parameter, "connection", number_integer);
	MESSAGE_ASSERT_FIELD(parameter, "user_id", number_unsigned);
...
nlohmann::json handle_getServerHash(const MumbleAPI &api, const std::string &bridgeSecret, const nlohmann::json &parameter) {
	// Validate specified parameter
	if (parameter.size() != 1) {
		throw InvalidMessageException(std::string("API function \"getServerHash\" expects 1 parameter(s) but got ") + std::to_string(parameter.size()));
	}
	MESSAGE_ASSERT_FIELD(parameter, "connection", number_integer);
...
nlohmann::json handle_getUserComment(const MumbleAPI &api, const std::string &bridgeSecret, const nlohmann::json &parameter) {
	// Validate specified parameter
	if (parameter.size() != 2) {
		throw InvalidMessageException(std::string("API function \"getUserComment\" expects 2 parameter(s) but got ") + std::to_string(parameter.size()));
	}
	MESSAGE_ASSERT_FIELD(parameter, "connection", number_integer);
	MESSAGE_ASSERT_FIELD(parameter, "user_id", number_unsigned);
...
nlohmann::json handle_getChannelDescription(const MumbleAPI &api, const std::string &bridgeSecret, const nlohmann::json &parameter) {
	// Validate specified parameter
	if (parameter.size() != 2) {
		throw InvalidMessageException(std::string("API function \"getChannelDescription\" expects 2 parameter(s) but got ") + std::to_string(parameter.size()));
	}
	MESSAGE_ASSERT_FIELD(parameter, "connection", number_integer);
	MESSAGE_ASSERT_FIELD(parameter, "channel_id", number_integer);
...
nlohmann::json handle_requestLocalUserTransmissionMode(const MumbleAPI &api, const std::string &bridgeSecret, const nlohmann::json &parameter) {
	// Validate specified parameter
	if (parameter.size() != 1) {
		throw InvalidMessageException(std::string("API function \"requestLocalUserTransmissionMode\" expects 1 parameter(s) but got ") + std::to_string(parameter.size()));
	}
...
nlohmann::json handle_requestUserMove(const MumbleAPI &api, const std::string &bridgeSecret, const nlohmann::json &parameter) {
	// Validate specified parameter
	if (parameter.size() != 4) {
		throw InvalidMessageException(std::string("API function \"requestUserMove\" expects 4 parameter(s) but got ") + std::to_string(parameter.size()));
	}
	MESSAGE_ASSERT_FIELD(parameter, "connection", number_integer);
	MESSAGE_ASSERT_FIELD(parameter, "user_id", number_unsigned);
	MESSAGE_ASSERT_FIELD(parameter, "channel_id", number_integer);
...
nlohmann::json handle_requestMicrophoneActivationOvewrite(const MumbleAPI &api, const std::string &bridgeSecret, const nlohmann::json &parameter) {
	// Validate specified parameter
	if (parameter.size() != 1) {
		throw InvalidMessageException(std::string("API function \"requestMicrophoneActivationOvewrite\" expects 1 parameter(s) but got ") + std::to_string(parameter.size()));
	}
...
nlohmann::json handle_requestLocalMute(const MumbleAPI &api, const std::string &bridgeSecret, const nlohmann::json &parameter) {
	// Validate specified parameter
	if (parameter.size() != 3) {
		throw InvalidMessageException(std::string("API function \"requestLocalMute\" expects 3 parameter(s) but got ") + std::to_string(parameter.size()));
	}
	MESSAGE_ASSERT_FIELD(parameter, "connection", number_integer);
	MESSAGE_ASSERT_FIELD(parameter, "user_id", number_unsigned);
...
nlohmann::json handle_requestLocalUserMute(const MumbleAPI &api, const std::string &bridgeSecret, const nlohmann::json &parameter) {
	// Validate specified parameter
	if (parameter.size() != 2) {
		throw InvalidMessageException(std::string("API function \"requestLocalUserMute\" expects 2 parameter(s) but got ") + std::to_string(parameter.size()));
	}
	MESSAGE_ASSERT_FIELD(parameter, "connection", number_integer);
	MESSAGE_ASSERT_FIELD(parameter, "muted", boolean);
...
nlohmann::json handle_requestLocalUserDeaf(const MumbleAPI &api, const std::string &bridgeSecret, const nlohmann::json &parameter) {
	// Validate specified parameter
	if (parameter.size() != 2) {
		throw InvalidMessageException(std::string("API function \"requestLocalUserDeaf\" expects 2 parameter(s) but got ") + std::to_string(parameter.size()));
	}
	MESSAGE_ASSERT_FIELD(parameter, "connection", number_integer);
...
nlohmann::json handle_requestSetLocalUserComment(const MumbleAPI &api, const std::string &bridgeSecret, const nlohmann::json &parameter) {
	// Validate specified parameter
	if (parameter.size() != 2) {
		throw InvalidMessageException(std::string("API function \"requestSetLocalUserComment\" expects 2 parameter(s) but got ") + std::to_string(parameter.size()));
	}
	MESSAGE_ASSERT_FIELD(parameter, "connection", number_integer);
...
nlohmann::json handle_findUserByName(const MumbleAPI &api, const std::string &bridgeSecret, const nlohmann::json &parameter) {
	// Validate specified parameter
	if (parameter.size() != 2) {
		throw InvalidMessageException(std::string("API function \"findUserByName\" expects 2 parameter(s) but got ") + std::to_string(parameter.size()));
	}
	MESSAGE_ASSERT_FIELD(parameter, "connection", number_integer);
...
nlohmann::json handle_findUserByName_noexcept(const MumbleAPI &api, const std::string &bridgeSecret, const nlohmann::json &parameter) {
	// Validate specified parameter
	if (parameter.size() != 2) {
		throw InvalidMessageException(std::string("API function \"findUserByName_noexcept\" expects 2 parameter(s) but got ") + std::to_string(parameter.size()));
	}
	MESSAGE_ASSERT_FIELD(parameter, "connection", number_integer);
	MESSAGE_ASSERT_FIELD(parameter, "user_name", string);
...
nlohmann::json handle_findChannelByName(const MumbleAPI &api, const std::string &bridgeSecret, const nlohmann::json &parameter) {
	// Validate specified parameter
	if (parameter.size() != 2) {
		throw InvalidMessageException(std::string("API function \"findChannelByName\" expects 2 parameter(s) but got ") + std::to_string(parameter.size()));
	}
	MESSAGE_ASSERT_FIELD(parameter, "connection", number_integer);
...
nlohmann::json handle_findChannelByName_noexcept(const MumbleAPI &api, const std::string &bridgeSecret, const nlohmann::json &parameter) {
	// Validate specified parameter
	if (parameter.size() != 2) {
		throw InvalidMessageException(std::string("API function \"findChannelByName_noexcept\" expects 2 parameter(s) but got ") + std::to_string(parameter.size()));
	}
	MESSAGE_ASSERT_FIELD(parameter, "connection", number_integer);
	MESSAGE_ASSERT_FIELD(parameter, "channel_name", string);
...
nlohmann::json handle_getMumbleSetting_bool(const MumbleAPI &api, const std::string &bridgeSecret, const nlohmann::json &parameter) {
	// Validate specified parameter
	if (parameter.size() != 1) {
		throw InvalidMessageException(std::string("API function \"getMumbleSetting_bool\" expects 1 parameter(s) but got ") + std::to_string(parameter.size()));
	}
...
nlohmann::json handle_getMumbleSetting_int(const MumbleAPI &api, const std::string &bridgeSecret, const nlohmann::json &parameter) {
	// Validate specified parameter
	if (parameter.size() != 1) {
		throw InvalidMessageException(std::string("API function \"getMumbleSetting_int\" expects 1 parameter(s) but got ") + std::to_string(parameter.size()));
	}
	MESSAGE_ASSERT_FIELD(parameter, "key", string);
...
nlohmann::json handle_getMumbleSetting_double(const MumbleAPI &api, const std::string &bridgeSecret, const nlohmann::json &parameter) {
	// Validate specified parameter
	if (parameter.size() != 1) {
		throw InvalidMessageException(std::string("API function \"getMumbleSetting_double\" expects 1 parameter(s) but got ") + std::to_string(parameter.size()));
	}
	MESSAGE_ASSERT_FIELD(parameter, "key", string);
...
nlohmann::json handle_getMumbleSetting_string(const MumbleAPI &api, const std::string &bridgeSecret, const nlohmann::json &parameter) {
	// Validate specified parameter
	if (parameter.size() != 1) {
		throw InvalidMessageException(std::string("API function \"getMumbleSetting_string\" expects 1 parameter(s) but got ") + std::to_string(parameter.size()));
	}
	MESSAGE_ASSERT_FIELD(parameter, "key", string);
...
nlohmann::json handle_setMumbleSetting_bool(const MumbleAPI &api, const std::string &bridgeSecret, const nlohmann::json &parameter) {
	// Validate specified parameter
	if (parameter.size() != 2) {
		throw InvalidMessageException(std::string("API function \"setMumbleSetting_bool\" expects 2 parameter(s) but got ") + std::to_string(parameter.size()));
	}
	MESSAGE_ASSERT_FIELD(parameter, "key", string);
...
nlohmann::json handle_setMumbleSetting_int(const MumbleAPI &api, const std::string &bridgeSecret, const nlohmann::json &parameter) {
	// Validate specified parameter
	if (parameter.size() != 2) {
		throw InvalidMessageException(std::string("API function \"setMumbleSetting_int\" expects 2 parameter(s) but got ") + std::to_string(parameter.size()));
	}
	MESSAGE_ASSERT_FIELD(parameter, "key", string);
...
nlohmann::json handle_setMumbleSetting_double(const MumbleAPI &api, const std::string &bridgeSecret, const nlohmann::json &parameter) {
	// Validate specified parameter
	if (parameter.size() != 2) {
		throw InvalidMessageException(std::string("API function \"setMumbleSetting_double\" expects 2 parameter(s) but got ") + std::to_string(parameter.size()));
	}
	MESSAGE_ASSERT_FIELD(parameter, "key", string);
...
nlohmann::json handle_setMumbleSetting_string(const MumbleAPI &api, const std::string &bridgeSecret, const nlohmann::json &parameter) {
	// Validate specified parameter
	if (parameter.size() != 2) {
		throw InvalidMessageException(std::string("API function \"setMumbleSetting_string\" expects 2 parameter(s) but got ") + std::to_string(parameter.size()));
	}
	MESSAGE_ASSERT_FIELD(parameter, "key", string);
...
nlohmann::json handle_sendData(const MumbleAPI &api, const std::string &bridgeSecret, const nlohmann::json &parameter) {
	// Validate specified parameter
	if (parameter.size() != 4) {
		throw InvalidMessageException(std::string("API function \"sendData\" expects 4 parameter(s) but got ") + std::to_string(parameter.size()));
	}
	MESSAGE_ASSERT_FIELD(parameter, "connection", number_integer);
...
nlohmann::json handle_log(const MumbleAPI &api, const std::string &bridgeSecret, const nlohmann::json &parameter) {
	// Validate specified parameter
	if (parameter.size() != 1) {
		throw InvalidMessageException(std::string("API function \"log\" expects 1 parameter(s) but got ") + std::to_string(parameter.size()));
	}
...
nlohmann::json handle_log_noexcept(const MumbleAPI &api, const std::string &bridgeSecret, const nlohmann::json &parameter) {
	// Validate specified parameter
	if (parameter.size() != 1) {
		throw InvalidMessageException(std::string("API function \"log_noexcept\" expects 1 parameter(s) but got ") + std::to_string(parameter.size()));
	}
	MESSAGE_ASSERT_FIELD(parameter, "message", string);
...
nlohmann::json handle_playSample(const MumbleAPI &api, const std::string &bridgeSecret, const nlohmann::json &parameter) {
	// Validate specified parameter
	if (parameter.size() != 1) {
		throw InvalidMessageException(std::string("API function \"playSample\" expects 1 parameter(s) but got ") + std::to_string(parameter.size()));
	}
...
nlohmann::json execute(const std::string &functionName, const MumbleAPI &api, const std::string &bridgeSecret, const nlohmann::json &msg) {
